...
namespace PaymentProcessor.Bussiness.Tests.Gateway
{
    ...
    public class PaymentGatewayPremiumTests
    {
        ...
        public void SetUp()
        {
            ...
            subject = new PaymentGatewayPremium(paymentValidatorMock.Object, externalProcessorMock.Object);
        }
        ...
        public void ValidatePaymentForGateway_WithInvalidData_ShouldReturnFalse(decimal amount)
        {
            ...
            Assert.IsFalse(GatewayType.GetGatewayTypeFromAmount(amount) == typeof(PaymentGatewayPremium));
        }
        ...
        public void ValidatePaymentForGateway_WithValidData_ShouldReturnTrue(decimal amount)
        {
            ...
            Assert.IsTrue(GatewayType.GetGatewayTypeFromAmount(amount) == typeof(PaymentGatewayPremium));
        }
    }
}
